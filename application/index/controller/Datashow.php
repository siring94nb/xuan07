...
//表创建
            ...
            Db::query("ALTER TABLE `ims_sudu8_page_products` CHANGE `sale_num` `sale_num` INT(11) NULL DEFAULT '0' COMMENT '卖出量';");
            ...
            if(count($base_04)<61){
                ...
                Db::query("ALTER table ims_sudu8_page_base ADD score_shoppay int(11) COMMENT '店内最大抵用积分'");
            ...
            if(count($duoProOrder_02)<21){
                Db::query("ALTER table ims_sudu8_page_duo_products_order ADD sid int(11) DEFAULT 0 COMMENT '多商户id'");
            }
            ...
            if(count($products_05)<59){
                ...
                Db::query("ALTER table ims_sudu8_page_products ADD get_share_gz int(11) NOT NULL DEFAULT '2' COMMENT '1开启2关闭'");

                Db::query("ALTER table ims_sudu8_page_products ADD get_share_score int(11) NOT NULL DEFAULT '0' COMMENT '他人点击分享获取积分'");

                Db::query("ALTER table ims_sudu8_page_products ADD get_share_num int(11) NOT NULL DEFAULT '0' COMMENT '他人点击分享次数'");
            ...
            if(count($products_07)<63){
                ...
                Db::query("ALTER table ims_sudu8_page_products ADD `glnews` text NOT NULL COMMENT '关联文章'");
            ...
            if(count($products_08)<64){
                ...
                Db::query("ALTER table ims_sudu8_page_products ADD `kuaidi` int(1) NOT NULL DEFAULT '0' COMMENT '0快递1到店自取'");
            ...
            if(count($user_01)<43){
                ...
                Db::query("ALTER table ims_sudu8_page_user ADD p_p_parent_id varchar(1000) NOT NULL DEFAULT '0' COMMENT '父级的父级的父级'");

                Db::query("ALTER table ims_sudu8_page_user ADD p_parent_id varchar(1000) NOT NULL DEFAULT '0' COMMENT '父级的父级'");

                Db::query("ALTER table ims_sudu8_page_user ADD parent_id varchar(1000) NOT NULL DEFAULT '0' COMMENT '父级'");

                Db::query("ALTER table ims_sudu8_page_user ADD fxs int(1) NOT NULL DEFAULT '1' COMMENT '1不是分销商2分销商'");

                Db::query("ALTER table ims_sudu8_page_user ADD fxstime int(11) NOT NULL DEFAULT '0'");

                Db::query("ALTER table ims_sudu8_page_user ADD fx_allmoney float NOT NULL DEFAULT '0' COMMENT '分销获得过的钱'");

                Db::query("ALTER table ims_sudu8_page_user ADD fx_getmoney float NOT NULL DEFAULT '0' COMMENT '分销已经提现的钱'");

                Db::query("ALTER table ims_sudu8_page_user ADD fx_money float NOT NULL DEFAULT '0' COMMENT '分销商获得过的钱分销可提现钱'");

                Db::query("ALTER table ims_sudu8_page_user ADD p_get_money float NOT NULL DEFAULT '0' COMMENT '父级获得的钱'");

                Db::query("ALTER table ims_sudu8_page_user ADD p_p_get_money float NOT NULL DEFAULT '0' COMMENT '父父级获得的钱'");

                Db::query("ALTER table ims_sudu8_page_user ADD p_p_p_get_money float NOT NULL DEFAULT '0' COMMENT '父父父级获得的钱'");
            ...
            if(count($user_03)<55){
                Db::query("ALTER table ims_sudu8_page_user ADD birth varchar(255) DEFAULT NULL COMMENT '生日'");
                Db::query("ALTER table ims_sudu8_page_user ADD vipid varchar(255) DEFAULT NULL COMMENT 'vip卡号'");
                Db::query("ALTER table ims_sudu8_page_user ADD vipcreatetime varchar(255) DEFAULT NULL COMMENT 'vip创建时间'");
            }
            ...
            if(count($fxgz_01)<12){
                ...
                Db::query("ALTER table ims_sudu8_page_fx_gz ADD fxs_name varchar(255) NOT NULL COMMENT '分销商'");
                ...
                Db::query("ALTER table ims_sudu8_page_fx_gz ADD thumb varchar(255) NOT NULL COMMENT '分享推广图'");

                Db::query("ALTER table ims_sudu8_page_fx_gz ADD sq_thumb varchar(255) NOT NULL COMMENT '申请图'");
            ...
            if(count($page_cate_01)<22){
                ...
                Db::query("ALTER table ims_sudu8_page_cate ADD `list_style_more` int(1) NOT NULL DEFAULT '1' COMMENT '1普通2左侧'");
            ...
            if(count($page_cate_02)<23){
                ...
                Db::query("ALTER table ims_sudu8_page_cate ADD `slide_is` int(1) NOT NULL DEFAULT '2' COMMENT '1启用2不启用'");
            ...
            if(count($pt_pro_03)<25){
                ...
                Db::query("ALTER table ims_sudu8_page_pt_pro ADD `kuaidi` int(1) NOT NULL DEFAULT '0' COMMENT '0快递1到店自取'");
            ...
            if(count($rechargeconf_01)<6){
                ...
                Db::query("ALTER table ims_sudu8_page_rechargeconf ADD `score_shoppay` int(11) NOT NULL DEFAULT '0' COMMENT '店内最大抵用积分' ");
            ...
            if(count($score_get_01)<8){
                ...
                Db::query("ALTER table ims_sudu8_page_pro_score_get ADD `clickopenid` varchar(255) NOT NULL COMMENT '点击人openid' ");
