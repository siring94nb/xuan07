...
class Index extends Controller
{
    ...
    public function index(){
		...
		$news1 = Db::table('ims_sudu8_page_system_news')->where("cate",1)->limit(3)->select();  
		if($news1){
		...
		$news2 = Db::table('ims_sudu8_page_system_news')->where("cate",2)->limit(3)->select();  
		if($news2){
		...
		$news3 = Db::table('ims_sudu8_page_system_news')->where("cate",3)->limit(3)->select(); 
		if($news3){
