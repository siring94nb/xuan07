...
<!-- 导航 -->
	...
	<div class="zhongjshuj"  style="padding:20px 40px 60px">
		...
		<div style="margin-top:50px; border-top:1px solid #dedede; padding-top:20px">
			...
			<form action="<?php echo Url('Applet/save_jxs'); ?>" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit = "return checkinfo();">
						...
						<div class="control-group">
							...
							<div class="controls" style="line-height:34px;">
								...
								<input name="username" type="text" id="username" class="span3 m-wrap" value="<?php if($userinfo): ?><?php echo $userinfo['username']; endif; ?>"/>

								<span style="color:#999999; line-height:40px; margin-left:20px;">密码默认为<em style="font-style: normal;color: #fff; background: #c00; padding: 0 5px">123456</em>，请登录帐号修改</span>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input type="radio" name="group" onchange="kkchanges(this)" value="3" checked=checked/>
						...
						<div class="control-group" id="xzgs">



							<label class="control-label">小程序限制个数</label>
							...
							<div class="controls">
								...
								<input name="num" type="number" class="span3 m-wrap" id="num" value="<?php if($userinfo): ?><?php echo $userinfo['num']; endif; ?>">
						...
						<div class="control-group" >
							...
							<label class="control-label">账号到期时间</label>
							...
							<div class="controls">
								...
								<input type="text" value="<?php if($userinfo): ?><?php echo date('Y-m-d H:i:s',$userinfo['overtime']); endif; ?>"  name="overtime"  readonly id="datetimepicker" data-date-format="yyyy-mm-dd hh:ii" placeholder="默认周期一年">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input type="radio" name="flag" onchange="kkchanges(this)" value="1" <?php if($userinfo): if($userinfo['flag']==1): ?>checked=checked<?php endif; else: ?>checked=checked<?php endif; ?>/>
								...
								<input type="radio" name="flag" onchange="kkchanges(this)" value="0" <?php if($userinfo): if($userinfo['flag']==0): ?>checked=checked<?php endif; endif; ?>/>
