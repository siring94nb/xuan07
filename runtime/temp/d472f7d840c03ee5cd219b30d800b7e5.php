...
<!-- 导航 -->
	...
	<div class="zhongjshuj"  style="padding:20px 40px 60px">
		...
		<div>
			...
			<a href="<?php echo Url('Applet/add_jxs'); ?>">
			<div class="addxcx">
				<i class="icon-plus"></i> 
				添加代理商
			</div>
			...
			<table class="table table-striped table-hover table-bordered" id="applet">
				...
				<tbody>
					...
					<tr class="">
						...
						<td><?php echo date('Y-m-d H:i:s',$item['overtime']); ?></td>
						...
						<td>
							<a href="<?php echo Url('Applet/add_jxs'); ?>?uid=<?php echo $item['uid']; ?>" style="float:left">
