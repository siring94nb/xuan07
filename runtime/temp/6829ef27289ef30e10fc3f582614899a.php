...
<!-- 导航 -->
	...
	<div class="zhongjshuj"  style="padding:20px 40px 60px">
		...
		<div style="margin-top:50px; border-top:1px solid #dedede; padding-top:20px">
			...
			<form action="<?php echo Url('Applet/save_admin'); ?>" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit = "return checkinfo();">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<?php if(\think\Session::get('usergroup')==2 || \think\Session::get('usergroup')==3): ?>
								...
								<input type="radio" name="group" onchange="kkchanges(this)" value="1" <?php if($userinfo): if($userinfo['group']==1): ?>checked=checked<?php endif; else: ?>checked<?php endif; ?>/>
